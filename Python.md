...
- `seek(offset = NUM,  whence = 0,1,2)` - `0` - moves read/write location to the beginning of the file. `1` - current position.   `2` - the end of the file
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY0ODMxNzI1NiwtMTE3ODYyOTcwOCwtMT
